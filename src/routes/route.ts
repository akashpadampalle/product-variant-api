 ...
 *         description: Internal Server Error. Something went wrong on the server.
 */
router.get('/products/:pid', productController.get);
 ...
 *         description: Internal Server Error. Something went wrong on the server.
 */
router.put('/products/:pid', productController.update);
 ...
 *         description: Internal Server Error. Something went wrong on the server.
 */
router.delete('/products/:pid', productController.remove);
 ...
 *         description: Internal Server Error. Something went wrong on the server.
 */
router.get('/products/:pid/variants', variantController.getAll);
 ...
 *         description: Internal Server Error. Something went wrong on the server.
 */
router.post('/products/:pid/variants', variantController.create);
 ...
 *         description: Internal Server Error. Something went wrong on the server.
 */
router.get('/products/:pid/variants/:vid', variantController.get);
 ...
 *         description: Internal Server Error. Something went wrong on the server.
 */
router.put('/products/:pid/variants/:vid', variantController.update);
 ...
 *         description: Internal Server Error. Something went wrong on the server.
 */
router.delete('/products/:pid/variants/:vid', variantController.remove);
